...
import com.hm.editor.adminservice.app.console.BaseFolderAppService;
...
public class BaseFoldersController {
    ...
    @Autowired
    private BaseFolderAppService baseFolderAppService;

    @Operation(summary = "获取所有数据集")
    @RequestMapping(value = "/getAll", method = RequestMethod.GET)
    public ApiResult<Object> getAll() {
        List<EmrDataSet> list = baseFolderAppService.getAll();
    ...
    public ApiResult<Object> getCondition(
        ...
        List<EmrDataElementAdmin> list = baseFolderAppService.getCondition(id);
        return ApiResult.success("查询成功", list);
    }
    ...
    public ApiResult<Object> getDataSet(@RequestBody Map<String, Object> param) {
        return ApiResult.success("查询成功", baseFolderAppService.getDataSet(param));
    }
    ...
    public ApiResult<Object> delBaseFolder(
        ...
        boolean flag = baseFolderAppService.delBaseFolder(id);
    ...
    public ApiResult<Object> addBaseFolder(@RequestBody Map<String, Object> param) {
        boolean flag = baseFolderAppService.addBaseFolder(param);
    ...
    public ApiResult<Object> editBaseFolder(@RequestBody Map<String, Object> param) {
        boolean flag = baseFolderAppService.editBaseFolder(param);
