...
public class FolderTemplateRepository {
  ...
  private Criteria getCri(Map<String, Object> param) {
    ...
    String templateName =
        param.containsKey("templateName") ? param.get("templateName").toString() : "";
  ...
  public boolean existOwnFolder(String id, String name) {
    return template.findOne(
            Query.query(Criteria.where("templateName").is(name).and("_id").ne(new ObjectId(id))),
  ...
  public String getBaseTemplateHtml(String id) {
    ...
    Map<String, Object> templateMap =
        template.findOne(
            Query.query(Criteria.where("_id").is(objectId)), Map.class, HTML_COLLECTION_NAME);
