...
import com.hm.editor.adminservice.app.console.DataElementAppService;
...
public class DataElementController {
    ...
    @Autowired
    private DataElementAppService dataElementAppService;

    @Operation(summary = "搜索数据元")
    @RequestMapping(value = "/search", method = RequestMethod.POST)
    public ApiResult<Object> getAll(@RequestBody Map<String, Object> param) {
        return ApiResult.success("查询成功", dataElementAppService.getAll(param));
    }
    ...
    public ApiResult<Object> delDataElenment(
        ...
        boolean flag = dataElementAppService.delDataElenment(id);
    ...
    public ApiResult<Object> updDataElenment(@RequestBody Map<String, Object> param) {
        boolean flag = dataElementAppService.updDataElenment(param);
    ...
    public ApiResult<Object> intDataElenment(@RequestBody Map<String, Object> param) {
        boolean flag = dataElementAppService.intDataElenment(param);
        return flag
    ...
    public void export(HttpServletResponse response) {
        dataElementAppService.export(response);
    }
    ...
    public boolean upload(
        ...
        return dataElementAppService.upload(file);
    }
    ...
    public ApiResult<Object> autoBind(@RequestBody Map<String, Object> templateDatasource) {
        boolean flag = dataElementAppService.autoBind(templateDatasource);
        if (flag) {
